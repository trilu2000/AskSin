...
/* Serial ID       10 byte */  'T','L','U','0','0','0','2','0','0','3', // serial ID, needed for pairing
...
HM::s_devParm dParm = {
/* device HM Id     3 byte */ {0xF4, 0xB6, 0x5D},						// very important, must be unique. identifier for the device in the network
